let missedProduct = newArray();
let cardState = false;
let card = document.querySelector(".card");

let sideMenu = document.querySelector(".side-menu");
let sideContent = document.querySelector(".side-menu .content");
let showsSideMenuToggle = document.querySelector(".toggle");
let closeSide = document.querySelector(".close");
let root = document.documentElement
showsSideMenuToggle.addEventListener("click", (e) => {
    sideMenu.classList.toggle("show-side-menu");
    sideContent.classList.toggle("show-contenr");
...
addBtn.addEventListener("click" , (e) => {
    ...
    let final = Number(countP.textContent) * 125.00;
    ...
    <div class="quantity">
      <span class="first">$125.00 x ${countP.textContent}</span>
...
// Display Image
// let currentP = document.querySelector(".current-prodact")
// let overParent = currentP.cloneNode(true);
